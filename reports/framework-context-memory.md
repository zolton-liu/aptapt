...
当前 v6.2 又增加了源码版本失效、主要修复片段与阶段执行证据，详见 [最新修改说明](framework-v6.2-contract-pipeline.md)；本文和下面的 v6.1 链接保留历史设计与验证口径。

本文保留 v6 阶段设计说明。后续 v6.1 调整了上下文近期历史、错误状态、预算与修复门槛；以 [v6.1 实施说明](recovery-v6.1-20260923.md) 和 [最终效果报告](recovery-v6.1-random10-results.md) 为当前状态。固定 10 题严格 pass@1 从 v6 的 1/10 恢复到 2/10，仍低于 v5.6 同题 4/10。
